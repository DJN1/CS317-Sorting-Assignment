 ...
 * DATE: 11/03/2020
 * COURSE: CS317-03
 * DESCRIPTION: This file implements all the "helper"/Utility functions to load the arrays with data, comapre two strings for the sorting algorithm and getting the input file for the assignment.
